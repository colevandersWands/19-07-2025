...
import {
  getExercisesForLang,
  supportsPseudocode,
} from '../../shared/context/ExerciseRegistry.js';
...
const ExercisePicker = () => {
  ...
  if (!currentFile) {
    return (
      <div className={styles.pickerContainer}>
        <div className={styles.emptyMessage}>Select a file to see study options</div>
      </div>
    );
  }
  ...
  const flashcardInfo =
    currentFile.lang === '.md'
      ? getFlashcardDirectoryForFile(currentFile.path, virtualFS)
      : null;
      ...
      return (
        <div className={styles.pickerContainer}>
          ...
          <div className={styles.markdownMessage}>
            ...
            <p>
              You can add annotations and drawings on top of the rendered content using
              the annotation tools in the rendered view.
            </p>
          </div>
        </div>
      );
  ...
  return (
    <div className={styles.pickerContainer}>
      ...
      <div className={styles.section}>
        ...
        {availableExercises
          .filter((exercise) => exercise.key === 'edit')
          .map((exercise) => (
            <button
              key={exercise.key}
